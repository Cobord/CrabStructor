...
mod test {
    ...
    fn lib_test() {
        ...
        #[constructor(field1 = r#"String::from("test")"#)]
        struct Example {
            field1: String,
            field2: i32,
        }
    ...
    fn lib_test_2() {
        ...
        #[derive(Constructor, Eq, PartialEq, Debug)]
        #[constructor(field1 = r#"String::from("test")"#)]
        #[constructor(field2, field4, field5)]
        #[constructor(field3 = r#"Example::new(-13)"#)]
        struct Example2 {
            field1: String,
            field2: i32,
            field3: Example,
